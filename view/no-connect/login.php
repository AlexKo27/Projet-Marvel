...
<head>
    <?php require_once __DIR__."/../include/head.php";// recuperation du chemin du dossier permettant l'acces ?>
</head>
  ...
  <body>
    ...
    <!-- Javascript files-->
    <?php require_once __DIR__."/../include/footer.php";// recuperation du chemin du dossier permettant l'acces ?>
  </body>
</html>